...
- Workaround: Some compilers claim that an enum is unsigned even if it contain enumerators with negative values. In this case the datatype is switched to a signed type.
